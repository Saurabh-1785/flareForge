...
interface IFAssetsRouter {
    event FundingReceived(uint256 indexed vaultId, address asset, uint256 amount);
    event RedemptionInitiated(uint256 indexed vaultId, address asset, uint256 amount, string destinationAddress);
